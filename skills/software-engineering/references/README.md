...
These references keep `software-engineering/SKILL.md` focused on execution ownership, carrier selection, and autonomous workflow selection while preserving detailed delegation, runtime-example, CRA, and TCA mechanics.
