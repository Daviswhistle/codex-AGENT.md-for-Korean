...
3. 처음 보는 사람도 이해할 수 있게 주석을 친절하고 자세하게 작성해. 한국어로 작성해. 주석에 나와 대화한 흔적은 남기지 마. 이건 나와 너만 작업하는 게 아니라 팀과의 협업이야. 네가 작업했다는 티를 주석에 내지 마(요청에 따라, 요청사항, 요구사항 등등).
...
11. commit까지만 하고 push는 하지 마. 
12. 주저하지 말고 최선을 다해줘.
13. 로컬의 AGENTS.md는 널 위한 파일이야. 과거 기억이 없는 미래의 너를 위해 현재의 네가 유용한 지침을 업데이트해도 좋아.
